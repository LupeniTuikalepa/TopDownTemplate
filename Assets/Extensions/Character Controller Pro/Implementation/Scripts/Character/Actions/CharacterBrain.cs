...
namespace Lightbug.CharacterControllerPro.Implementation
{
    ...
    public class CharacterBrain : MonoBehaviour
    {
        ...
        [SerializeField]
        InputHandlerSettings inputHandlerSettings;
        ...
        protected virtual void Awake()
        {
            ...
            if (!isAI && inputHandlerSettings.InputHandler == null)
            {
                Debug.Log("Brain mode is set to 'player' but the input handler is null.");
            }
