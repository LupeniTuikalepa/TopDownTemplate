...
namespace Lightbug.CharacterControllerPro.Demo
{
    ...
    /// </summary>
    [System.Serializable]
    public class PlatformMovementAction
    {
        [SerializeField]
        bool enabled = true;
        ...
        public void Tick(float dt, ref Vector3 position)
        {
            ...
            else
            {
                ...
                if (isWaiting)
                    ...
                    actionVector = (useWorldCoordinates ? direction : initialLocalDirection) * (speed * dt);
            }
    ...
    [CustomPropertyDrawer(typeof(PlatformMovementAction))]
    public class PlatformMovementActionDrawer : PropertyDrawer
    {
