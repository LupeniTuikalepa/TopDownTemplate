...
namespace Lightbug.CharacterControllerPro.Demo
{
    ...
    [DefaultExecutionOrder(ExecutionOrder.CharacterGraphicsOrder + 100)]
    public class Camera3D : MonoBehaviour
    {
        public InputHandlerSettings inputHandlerSettings;
        ...
        void Update()
        {
            ...
            Vector2 lookInput = inputHandlerSettings.InputHandler.GetVector2("Look");
            float zoomInput = inputHandlerSettings.InputHandler.GetFloat("Zoom");
            
            SetYawInput(lookInput.x);
            SetPitchInput(-lookInput.y);
