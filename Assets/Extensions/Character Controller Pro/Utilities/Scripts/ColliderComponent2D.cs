...
namespace Lightbug.Utilities
{
    ...
    public abstract class ColliderComponent2D : ColliderComponent
    {
        ...
        public override Vector3 ComputePenetrationVector(ref Vector3 position, ref Quaternion rotation,
            PenetrationDelegate Action)
        {
            ...
            for (int i = 0; i < overlaps; i++)
            {
                ...
                Action?.Invoke(ref position, ref rotation, otherCollider.transform, -colliderDistance2D.normal,
        ...
        protected int FilterValidOverlaps(int hits, Collider2D[] overlapsBuffer, List<Collider2D> filteredOverlaps,
            OverlapFilterDelegate2D Filter)
        {
