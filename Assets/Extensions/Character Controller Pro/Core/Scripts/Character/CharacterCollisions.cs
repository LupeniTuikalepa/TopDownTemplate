...
namespace Lightbug.CharacterControllerPro.Core
{
    ...
    { 
        ...
        public CollisionInfo CheckForGround(Vector3 position, float stepOffset, float stepDownDistance, in HitInfoFilter hitInfoFilter, HitFilterDelegate hitFilter = null)
        {
            ...
            Vector3 castDisplacement = displacement + Vector3.Normalize(displacement) * (preDistance + ContactOffset);
        ...
        /// <param name="hitInfoFilter">Filter values associated with the physics query.</param>
        /// <param name="hitFilter">A callback called for each obstacle detected.</param>
